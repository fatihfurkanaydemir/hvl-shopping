...
namespace WebApi.Controllers.v1
{
  public class ProductController : BaseApiController
  {
    ...
    // GET: api/<controller>
    [HttpGet("Search")]
    public async Task<IActionResult> GetBySearchFilter([FromQuery] GetProductsBySearchFilterParameter filter)
    {
      return Ok(await Mediator.Send(new GetProductsBySearchFilterQuery() { FilterString = filter.FilterString, PageSize = filter.PageSize, PageNumber = filter.PageNumber }));
    }
